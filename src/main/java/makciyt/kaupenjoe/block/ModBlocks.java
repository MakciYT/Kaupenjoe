package makciyt.kaupenjoe.block;

import makciyt.kaupenjoe.Kaupenjoe;
import makciyt.kaupenjoe.block.custom.*;
import makciyt.kaupenjoe.item.ModItemGroup;
import makciyt.kaupenjoe.item.ModItems;
import makciyt.kaupenjoe.item.custom.trees.RedwoodTree;
...
public class ModBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS
            = DeferredRegister.create(ForgeRegistries.BLOCKS, Kaupenjoe.MOD_ID);
    ...
    public static final RegistryObject<Block> AMETHYST_BLOCK = registerBlock("amethyst_block",
            () -> new Block(AbstractBlock.Properties.create(Material.IRON, MaterialColor.DIAMOND)
                    .harvestTool(ToolType.PICKAXE).harvestLevel(2).setRequiresTool()
                    .hardnessAndResistance(5.0F, 80.0F).sound(SoundType.METAL)));

    public static final RegistryObject<Block> AMETHYST_STAIRS = registerBlock("amethyst_stairs",
            () -> new StairsBlock(() -> AMETHYST_BLOCK.get().getDefaultState(), AbstractBlock.Properties.create(Material.IRON)
    ...
    public static final RegistryObject<Block> AMETHYST_BUTTON = registerBlock("amethyst_button",
            () -> new StoneButtonBlock(AbstractBlock.Properties.create(Material.IRON)
                    .harvestLevel(3).harvestTool(ToolType.PICKAXE).setRequiresTool().doesNotBlockMovement()));
    ...
    public static final RegistryObject<Block> REDWOOD_WALL_SIGN = BLOCKS.register("redwood_wall_sign",
            () -> new ModWallSignBlock(AbstractBlock.Properties.create(Material.WOOD).doesNotBlockMovement(), ModWoodTypes.REDWOOD));

    public static final RegistryObject<Block> REDWOOD_SIGN = BLOCKS.register("redwood_sign",
            () -> new ModStandingSignBlock(AbstractBlock.Properties.create(Material.WOOD).doesNotBlockMovement(), ModWoodTypes.REDWOOD));

    public static final RegistryObject<Block> SPEAKER = registerBlock("speaker",
            () -> new SpeakerBlock(AbstractBlock.Properties.create(Material.IRON).notSolid()));
