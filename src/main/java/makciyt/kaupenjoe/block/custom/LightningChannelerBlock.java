...
import makciyt.kaupenjoe.container.LightningChannelerContainer;
import makciyt.kaupenjoe.tileentity.LightningChannelerTile;
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.kaupenjoe.lightning_channeler");
            }
