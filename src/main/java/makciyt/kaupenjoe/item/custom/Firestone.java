...
import makciyt.kaupenjoe.util.ModTags;
...
public class Firestone extends Item {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if(Screen.hasShiftDown()) {
            tooltip.add(new TranslationTextComponent("tooltip.kaupenjoe.firestone_shift"));
        } else {
            tooltip.add(new TranslationTextComponent("tooltip.kaupenjoe.firestone"));
        }
