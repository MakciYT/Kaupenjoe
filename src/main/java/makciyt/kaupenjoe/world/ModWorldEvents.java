package makciyt.kaupenjoe.world;

import com.mojang.serialization.Codec;
import makciyt.kaupenjoe.Kaupenjoe;
import makciyt.kaupenjoe.world.gen.*;
...
public class ModWorldEvents {
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld) {
            ...
            tempMap.putIfAbsent(ModStructures.DOMIK.get(),
                    DimensionStructuresSettings.field_236191_b_.get(ModStructures.DOMIK.get()));
