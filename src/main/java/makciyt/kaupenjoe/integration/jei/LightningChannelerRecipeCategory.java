...
public class LightningChannelerRecipeCategory implements IRecipeCategory<LightningChannelerRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Kaupenjoe.MOD_ID, "lightning");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Kaupenjoe.MOD_ID, "textures/gui/lightning_channeler_gui.png");
